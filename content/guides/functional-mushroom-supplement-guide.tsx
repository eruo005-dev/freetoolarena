...
export const body: ReactElement = (
  <>
    ...
    <p>The research base is small but growing. Lion&rsquo;s Mane has preliminary human data suggesting mild cognitive and mood effects in older adults. Reishi is studied for sleep quality and stress response. Cordyceps shows small endurance and VO2 max improvements in trained populations. Chaga and Turkey Tail have immune-modulation research, with Turkey Tail&rsquo;s PSK compound used as an adjunct cancer therapy in Japan. None of these are wonder drugs. The effect sizes in studies are modest, and many trials are small, short, or industry-funded.</p>
