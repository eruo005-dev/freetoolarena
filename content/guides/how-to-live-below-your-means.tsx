...
export const body = (
  <>
    ...
    <p>
      When income goes up, lifestyle quietly follows — a phenomenon called lifestyle creep.
    ...
    <p>
      Streaming, apps, memberships, cloud storage — these silently add up. Most people are
