...
export const body = (
  <>
    ...
    <p>
      The single most impactful change. Your circadian rhythm runs on regularity, not average
    ...
    <p>
      Core body temperature drops during sleep. A cool room helps you fall asleep faster and stay
