export const intro = (
  <>
    <p>
      Building muscle is one of the highest-ROI things you can do for your
...
export const body = (
  <>
    <h2>1. Compound lifts are 80% of the results</h2>
    <p>
    ...
    <p>
      Creatine (5g/day) and whey protein are worth buying. Everything else —
