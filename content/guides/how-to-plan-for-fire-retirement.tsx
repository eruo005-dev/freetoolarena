...
export const intro: ReactElement = (
  <p>
    FIRE &mdash; Financial Independence, Retire Early &mdash; is less about retiring in your 30s and more about buying back your time, on your schedule.
  </p>
);
...
export const body: ReactElement = (
  <>
    ...
    <p>
      Annual spending &times; 25 = your FIRE number (at a 4% withdrawal rate). Spend $50k/year? You need $1.25M invested. Spend $80k? You need $2M. This is the single most clarifying number in personal finance &mdash; it turns &ldquo;retirement&rdquo; from a vague feeling into a target. Use our FIRE number calculator to model different spending levels and see how the timeline shifts.
    </p>
